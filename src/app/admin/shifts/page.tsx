...
import { ArrowLeft, Plus, Clock, Users, Edit, Trash2 } from 'lucide-react';
...
export default function AdminShiftsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.employeeId || !formData.startTime || !formData.endTime || formData.weekdays.length === 0) {
    ...
    try {
      ...
      setFormData({ employeeId: '', weekdays: [], startTime: '', endTime: '', isActive: true });
      await loadData();
    } catch (err: unknown) {
      ...
      <div className="max-w-md mx-auto p-4">
        ...
        {shifts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">No shifts scheduled</h2>
            <p className="text-gray-600 mb-4">Create your first employee shift schedule</p>
            <button
              onClick={() => setShowForm(true)}
